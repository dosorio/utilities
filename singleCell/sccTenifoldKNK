sccTenifoldKNK <- function(X, Y, qc_mtThreshold = 0.1, qc_minLSize = 1000, qc_minNvalues = 500, nc_q = 0.95, nc_nCell = 500, nc_nNet = 2, nc_K = 2, nc_denoiseNet = TRUE, ma_nDim = 30){
